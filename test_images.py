...
model.load_weights('/content/drive/MyDrive/logs/denta20210117T2227/mask_rcnn_denta_0020.h5', by_name=True, exclude=[ "mrcnn_class_logits", "mrcnn_bbox_fc", "mrcnn_bbox", "mrcnn_mask"]) #if you run test this script on your local system you need to replace this path 

class_names = ['Caries', 'Emile']
